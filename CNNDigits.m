...
layers = [imageInputLayer([28 28 1])
          ...
          softmaxLayer
          classificationLayer()]; %183.23s %0.9812 Acc
...
%     fullyConnectedLayer(10)
%     softmaxLayer
%     classificationLayer(); %322.8s %0.988 Acc
...
%           fullyConnectedLayer(10)
%           softmaxLayer
%           classificationLayer()]; %477.04s %0.9648 Acc
...
%           fullyConnectedLayer(10)
%           softmaxLayer
%           classificationLayer()]; %182.61s %0.8592 Acc
...
%           fullyConnectedLayer(10)
%           softmaxLayer
%           classificationLayer()]; %805.96s %0.9284 Acc
